...
//        recyclerView 참고:https://m.blog.naver.com/PostView.nhn?blogId=oaie&logNo=221378779560&proxyReferer=https:%2F%2Fwww.google.com%2F
    ...
    private void eating_alone(View view){
        listview = view.findViewById(R.id.first_list);
        LinearLayoutManager layoutManager = new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false);
        listview.setLayoutManager(layoutManager);
//        DB구현부분
        ArrayList<item_list> itemList = new ArrayList<item_list>();
        itemList.add(new item_list(R.drawable.toast,"토스트", "식빵,햄, 계란 등등"));
        itemList.add(new item_list(R.drawable.toast,"토스트", "식빵,햄, 계란 등등"));
        itemList.add(new item_list(R.drawable.toast,"토스트", "식빵,햄, 계란 등등"));
        itemList.add(new item_list(R.drawable.spammayo,"스팸마요덮밥", "스팸, 마요네즈, 밥, 등등"));
        itemList.add(new item_list(R.drawable.tomato, "토마토 스파게티", "토마토, 스파게티, 등등"));
        itemList.add(new item_list(R.drawable.toast,"토스트", "식빵,햄, 계란 등등"));
//        여기까지
...
//        여기까지
    ...
    private void snack(View view){
        listview = view.findViewById(R.id.third_list);
        LinearLayoutManager layoutManager = new LinearLayoutManager(mContext, LinearLayoutManager.HORIZONTAL, false);
        listview.setLayoutManager(layoutManager);
//        DB구현부분
        ArrayList<item_list> itemList = new ArrayList<item_list>();
